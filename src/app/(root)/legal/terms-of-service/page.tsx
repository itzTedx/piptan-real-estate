		...
		<main className="container py-8 sm:py-12 md:py-16 lg:py-20">
			<article className="mx-auto max-w-prose">
				...
				<section className="mb-8">
					<p className="mb-4 text-base text-foreground/90 leading-relaxed sm:text-lg">
				...
				{/* Company Information */}
				<section className="mb-8">
					<h2 className="mb-4 font-semibold text-2xl sm:text-3xl">
						1. Company Information
					</h2>
					<div className="space-y-3 text-base text-foreground/90 leading-relaxed sm:text-lg">
						<p>
				...
				<section className="mb-8">
					...
					<div className="space-y-4 text-base text-foreground/90 leading-relaxed sm:text-lg">
						...
						<div className="flex flex-col items-start gap-6 rounded-lg border bg-muted p-6 sm:flex-row sm:items-center">
				...
				<section className="mb-8">
					<div className="rounded-lg border bg-muted p-6">
						...
						<p className="mt-4 text-base text-foreground/90 leading-relaxed sm:text-lg">
