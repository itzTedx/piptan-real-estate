		...
		<main className="container py-4 sm:py-9">
			...
			<section className="my-20">
				...
				<div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2">
					<p className="font-light text-lg text-primary-foreground leading-relaxed sm:text-xl">
			...
			<section className="mb-16 md:mb-24">
				...
				<div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
					{[
						...
						<div
							className="group rounded-lg bg-muted/50 p-6 transition-colors duration-300 hover:bg-muted"
							key={index}
						>
							<span className="mb-4 block text-4xl">{service.icon}</span>
							<h3 className="mb-2 font-medium text-xl">{service.title}</h3>
			...
			<section className="mb-16 md:mb-24">
				...
				<div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
					{[
						...
						<div className="group flex items-start gap-3" key={index}>
				...
				<div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
					{[
						...
						<div
							...
							key={index}
						>
							<span className="mb-2 block text-primary text-xl transition-transform duration-300 group-hover:scale-110">
								{index + 1}
							</span>
