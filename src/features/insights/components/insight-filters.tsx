		...
		>
			...
			<div className="relative">
				...
				{isSearching ? (
					...
					<Button
						className="absolute top-1/2 right-1 size-8 -translate-y-1/2 hover:bg-muted"
				...
				{isSearchFocused && !localSearchValue && (
					<div className="absolute top-full right-0 left-0 z-50 mt-1 rounded-md border bg-background shadow-lg">
						<div className="p-2">
