			...
			<div className="grid gap-6 pt-12 md:grid-cols-12 md:gap-8 lg:gap-12 lg:pt-20">
				{data.description && (
					<div className={cn(image ? "md:col-span-5" : "md:col-span-full")}>
						<h2 className="mb-4 font-medium text-2xl leading-snug sm:text-3xl md:mb-6 md:text-4xl">
				...
				{image && (
					<div className="sticky top-[15vh] aspect-4/3 w-full overflow-hidden rounded-sm border bg-muted sm:aspect-5/4 md:col-span-7">
						<Image
