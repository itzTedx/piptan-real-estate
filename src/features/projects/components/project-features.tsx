...
export const ProjectFeatures = ({ features }: ProjectFeaturesProps) => {
	return (
		features && (
			<section aria-label="Key Features" className="py-12 md:py-16 lg:py-20">
				...
				>
					{features.map((feature, index) => (
						<li
							className="flex w-full items-center gap-2 text-lg transition duration-300 hover:border-muted-foreground md:py-3 md:text-xl lg:text-2xl"
							key={index}
						>
